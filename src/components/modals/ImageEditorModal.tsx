...
export const ImageEditorModal: React.FC<ImageEditorModalProps> = ({
    ...
    // --- Model State ---
    const [selectedModel, setSelectedModel] = useState(initialModel || 'chuhaibang');
    ...
    useEffect(() => {
        ...
        setSelectedModel(initialModel || 'gem-3.0');
        ...
        <div className="fixed inset-0 z-[9999] bg-black flex flex-col">
            ...
            <div className="h-14 flex items-center justify-between px-4">
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-neutral-300">{t('modals.imageEditor.title')}</span>
                </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        title={t('modals.imageEditor.download')}
                    >
                    ...
                    <button
                        onClick={onClose}
                        className="w-10 h-10 rounded hover:bg-neutral-800 flex items-center justify-center text-neutral-400"
                        title={t('modals.imageEditor.exitEditor')}
                    >
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <div className="flex-1 flex items-center justify-center bg-black p-4 overflow-hidden min-h-0">
                    {localImageUrl ? (
                            ...
                            {text.editingTextId && elements.filter(el => el.type === 'text' && el.id === text.editingTextId).map(el => {
                                ...
                                return (
                                    <input
                                        ...
                                        autoFocus
                                        className="absolute bg-transparent border-2 border-white/30 outline-none text-white"
                                        style={{
                                            left: el.x,
                                            top: el.y,
                            ...
                            {crop.isCropMode && crop.cropRect && (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            {t('modals.imageEditor.cancel')}
                                        </button>
                                        <button
                                            onClick={(e) => { e.stopPropagation(); crop.applyCrop(); }}
                                            className="px-3 py-1.5 sf-rainbow-btn rounded-lg text-sm font-medium transition-colors"
                                        >
                                            {t('modals.imageEditor.apply')}
                                        </button>
                                    </div>
                                </div>
                            )}
                        ...
                        <div className="w-[600px] h-[400px] bg-neutral-100 rounded flex items-center justify-center">
                            <span className="text-neutral-400">{t('modals.imageEditor.noImageLoaded')}</span>
                        </div>
                    )}
                </div>
            </div>
