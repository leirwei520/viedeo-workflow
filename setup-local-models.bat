@echo off
REM ============================================================================
REM Chuhai Bang - Local Models Setup Script (Windows)
REM 
...
echo.
echo ========================================
echo  Chuhai Bang Local Models Setup
echo ========================================
echo.
...
if not exist models\camera-control\qwen-rapid-aio mkdir models\camera-control\qwen-rapid-aio
if not exist models\camera-control\loras mkdir models\camera-control\loras
