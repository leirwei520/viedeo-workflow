# Local Open-Source Model Support for Chuhai Bang

Enable users to download open-source AI models and use them in the Chuhai Bang canvas workflow with a simple, guided UI—no ComfyUI complexity needed.

---

## Design Philosophy

| Approach | Chuhai Bang | ComfyUI |
|----------|-----------|---------|
...
Instead of exposing nodes to users, Chuhai Bang maintains internal workflows for each model architecture:
