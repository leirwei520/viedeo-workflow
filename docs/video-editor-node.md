...
The Video Editor node allows you to trim videos directly within the Chuhai Bang canvas. It provides a timeline-based interface for selecting start and end points, and exports the trimmed video to your library for use in further video generation workflows.
